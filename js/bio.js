(function(){
  ...
  audio.src = encodeURI('../music/Star_Wars_-_imperskijj_marsh_62710962.mp3');
  audio.loop = true;
  audio.preload = 'auto';
...
(function(){
  ...
  function openPanel(){
    ...
    vol.value = (window.pageAudio.volume || 0).toFixed(2);
  ...
  btn.addEventListener('click', function(){ panel.style.display = panel.style.display==='block' ? 'none':'block'; if(panel.style.display==='block') openPanel(); });
